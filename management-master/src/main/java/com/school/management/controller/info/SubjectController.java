...
public class SubjectController  extends BaseController {
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(Subject subject, HttpServletRequest request)
    {
        HttpSession session = request.getSession();
        subject.setCreateBy((Long) session.getAttribute("uuid"));
        try {
    ...
    public String edit(@PathVariable("subjectId")Long subjectId, ModelMap map){
    ...
    @PostMapping("/update")
    @ResponseBody
    public AjaxResult update(Subject subject, HttpServletRequest request)
    {
        try {
            HttpSession session = request.getSession();
            subject.setUpdateBy((Long) session.getAttribute("uuid"));
    ...
    @ResponseBody
    public AjaxResult changeElective(Subject subject, HttpServletRequest request)
    {
        HttpSession session = request.getSession();
        subject.setUpdateBy((Long) session.getAttribute("uuid"));
