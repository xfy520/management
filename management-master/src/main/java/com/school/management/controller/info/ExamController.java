...
public class ExamController extends BaseController {
    ...
    public String edit(@PathVariable("examId")Long examId, HttpServletRequest request, ModelMap map){
        subjectClass(map, request);
    ...
    private void subjectClass(ModelMap map, HttpServletRequest req) {
        ...
        teacher.setPerms((int) session.getAttribute("perms"));
        teacher.setUserId((Long) session.getAttribute("uuid"));
